...
$templates = [
    'en' => [
        'admin_subject' => "New lead from ",
        'client_subject' => "We received your request - White Eagles & Co.",
        'greeting' => "Hello {name}",
        'intro' => "Thank you for your request. I have received your inquiry and will contact you shortly.",
    ...
    'sk' => [
        ...
        'intro' => "Ďakujem za Vašu žiadosť. Prijal som Váš dopyt a čoskoro sa Vám ozvem.",
    ...
    'ru' => [
        ...
        'intro' => "Благодарю за Вашу заявку. Я получил ваш запрос и свяжусь с Вами в самое ближайшее время.",
