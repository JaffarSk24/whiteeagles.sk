// Cache-bust: v5 (Exact NounProject Sad Cat)
import React, { useEffect, useState } from 'react';
import { useTranslation } from 'react-i18next';
import { X } from 'lucide-react';
import './ExitPopup.css';
import sadCatUrl from '../assets/sad-cat.png';
    ...
    <div className="exit-popup-overlay" onClick={handleClose}>
      <div className="exit-popup-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="exit-popup-icon-wrapper">
          <div 
            className="exit-popup-icon-custom" 
            style={{ 
              WebkitMaskImage: `url(${sadCatUrl})`,
              maskImage: `url(${sadCatUrl})`
            }} 
          />
        </div>
