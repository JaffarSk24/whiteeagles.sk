...
key: 'chatbot'
faq:
  - q: 'What does building a bot cost?'
    a: 'A bot for a specific job starts at 500 euros, with changes at 25 euros an hour. The price depends not on the number of messages but on integrations: linking to the site, a calendar, stock or payments is where the work actually is.'
  ...
  - q: 'How long does development take?'
    a: 'A simple enquiry bot with notifications takes a few days. A booking bot linked to the site and a calendar takes one to two weeks, depending on what already exists.'
---
![A chatbot for your business | White Eagles & Co.](/assets/blog/chatbotbus.webp)
...
## What a bot does badly

Honestly, point by point:

**Selling something complex.** If the decision needs a conversation, a bot only gets in the way.

**Handling an unhappy client.** Someone with a problem is infuriated by a bot. This needs a person, quickly.

**Answering what was never built into it.** A bot that replies "I did not understand" to every non-standard question works against you.

**Substituting for a process that does not exist.** If enquiries get lost because there is nobody to handle them, a bot merely speeds up the loss.

## Telegram or a widget on the site

That is usually the choice, and it depends on where your client is.

| | Site widget | Telegram |
|---|---|---|
| **Who it catches** | someone already on the site | someone arriving from anywhere |
| **After the tab closes** | conversation lost | conversation stays |
| **For your staff** | a separate panel | the phone already in their hand |
...
## What to measure to know whether it paid

Three numbers worth recording before launch and checking a month later:
...
## Mistakes that turn a bot against you

**Popping up three seconds after arrival.** The person has not yet worked out where they are.

**No route to a human.** A "talk to a person" button belongs in the very first menu.

**Silent at night.** A bot that says nothing outside working hours is useless at exactly the time it could be working instead of you. "We will reply in the morning, meanwhile here are answers to common questions" beats silence.

**Too many steps.** If there are five questions before the enquiry, not everyone reaches the end.

**Not reporting the enquiry anywhere.** The classic: the bot collects the data, it lands in a database, and nobody looks at it.

## When a bot is not needed

Plainly, because this is more common than it seems:
...
The fifth step matters more than the first four: real questions always differ from the expected ones.
