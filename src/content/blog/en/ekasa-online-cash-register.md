---
title: 'eKasa in 2026: who needs an online cash register and what changed on 1 January'
description: >-
  Slovakia''s new revenue recording act No. 384/2025: from 1 January the
  exemptions for services are gone, and from 1 May you must let customers pay
  cashlessly on anything above one euro. Penalties, exemptions and what it means
  for your website.
date: '2026-08-04'
key: 'ekasa'
faq:
  - q: 'Do I need an eKasa if I only invoice and get paid by bank transfer?'
    a: 'No. The obligation applies to sellers who take payment in cash or by card on the spot. Invoicing with payment by transfer is outside it, which is why many B2B companies legitimately operate without a cash register.'
  - q: 'From when am I obliged to accept cashless payment?'
    a: 'From 1 May 2026, on any purchase above one euro. There is one exception: no internet connection at the point of sale.'
  - q: 'Does the obligation now cover services as well?'
    a: 'Yes. From 1 January 2026 it covers all services without exception, including craft trades that used to be exempt.'
  - q: 'Do I have to install a card terminal?'
    a: 'No. The law requires you to make cashless payment possible, not to install a terminal. A QR code for a bank transfer satisfies the requirement and costs less.'
...
I set up card payment on websites, connect payment gateways, and wire the whole thing to measurement so it is clear how many orders actually reach payment. Details on the [web development service page](/en/service/webdev/).

I have lived in Slovakia for over ten years, work as a Slovak s.r.o. and issue a faktúra with an IČO.

Related: [accepting card payments on your website](/en/blog/accept-card-payments/), [VAT registration in Slovakia](/en/blog/vat-registration-slovakia/) and [opening an s.r.o.](/en/blog/open-sro-in-slovakia/).
