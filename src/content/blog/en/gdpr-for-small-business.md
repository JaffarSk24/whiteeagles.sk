---
title: 'GDPR for a small business: what you actually need on your website'
description: >-
  No size threshold, no exemption for a three-person firm. What counts as
  personal data in practice, the minimum set your site needs, what belongs
  outside the site, and the mistakes inspections find first.
date: '2026-08-04'
key: 'gdpr-small-business'
faq:
  - q: 'We are three people. Does GDPR apply to us?'
    a: 'Yes. GDPR applies to anyone processing personal data regardless of size. The relief for organisations under 250 people only covers keeping processing records, and it does not apply when processing is regular — an enquiry form working every day is regular processing.'
  - q: 'What counts as personal data on a website?'
    a: 'Name, email and phone from a form, IP addresses and cookie identifiers, session recordings in tools like Microsoft Clarity, chat conversations, and invoicing details.'
  - q: 'Can I copy a privacy policy from another company?'
    a: 'No — and an inspector spots it immediately, usually because the other company''s name or services are still in it. The policy has to describe what you actually do.'
  - q: 'How long do I have to report a data breach?'
    a: '72 hours. Which is why the procedure — who to call, what to check, who notifies the authority — has to exist before an incident rather than be invented during one.'
  - q: 'Does a pre-ticked consent box count as consent?'
    a: 'No. Consent has to be an active action. A box ticked by default is not consent, and it is one of the most common findings.'
---
![GDPR for a small business | White Eagles & Co.](/assets/blog/gdpreurope.webp)
...
**A cookie banner**, if analytics or advertising is present. That is a topic of its own — [the cookie banner in 2026](/en/blog/cookie-banner-2026/).

**The company's mandatory details.** Formally a separate requirement, but inspections tend to look at everything at once — [the full list](/en/blog/mandatory-website-details/).
...
I set up forms that ask only for what is needed, a cookie banner that actually blocks what it should before consent, and analytics that keeps working afterwards. Details on the [cookie consent service page](/en/service/cookies/).

I have lived in Slovakia for over ten years, work as a Slovak s.r.o. and issue a faktúra with an IČO.

Related: [the cookie banner in 2026](/en/blog/cookie-banner-2026/) and [mandatory website details](/en/blog/mandatory-website-details/).
