---
title: 'What Google Ads costs in Slovakia: budget, cost per click, what you pay for'
description: >-
  Real figures for advertising in Slovakia: what makes up the cost per click,
...
## What the sum is actually made of
...
**3. Management.** Monthly: search terms reports, clearing out rubbish, adjusting bids, testing ads.

A common beginner's mistake is paying only for the first. A campaign without management degrades: the negative keyword list stops growing, and within a couple of months a noticeable share of the budget goes on queries you do not want.

## Cost per click: why it is what it is

Google has no fixed price. There is an auction, and two multipliers enter it.
...
Exact values depend on the niche, but the order of magnitude is this:
...
1. **Cost per enquiry** = spent ÷ number of contacts.
...
Related: [Google Ads: how not to waste the budget](/en/blog/google-ads-getting-started/), [Google Ads or Meta](/en/blog/google-ads-or-meta/) and [ads running, no enquiries](/en/blog/ads-running-no-leads/).
