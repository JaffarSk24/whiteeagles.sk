---
title: 'Online booking on your website: how it works, who it pays off for, what it costs'
description: >-
  A booking system on your own site instead of phone calls and a spreadsheet:
...
# Online booking on your website: how it works, who it pays off for, what it costs

Booking by phone has one property that is hard to defend: it only works while somebody is there to pick up. Someone who wants to book a table at half past ten in the evening will not call in the morning. They will call somewhere else.

Below: what booking on a website has to do, why confirmation is handled through Telegram, what really drives the price, and when none of it is needed.

[CTA_FORM:webdev]

## What booking actually solves
...
The list is short, and every item has a reason.

**Show real availability.** Not a "tell us when suits you" form, but availability. The difference is whether the customer gets an answer immediately or only after you call back.
...
**Work on a phone.** More than half of bookings arrive from mobile. A calendar where you have to hit a small number with a finger is a lost customer.

## Why Telegram rather than another panel
...
## Ready service or a custom build

Honestly, without campaigning for either side.

| | Ready service | Custom build |
|---|---|---|
| **Start** | fast | longer |
| **Payment** | monthly, often a % per booking | one-off |
| **Look** | theirs, with their logo | your site |
| **Non-standard logic** | whatever the app can do | built to the brief |
| **Customer data** | with them | with you |
| **Link to the site** | a link away from your page | part of the page |

The practical test is a single question: **do you have logic the ready service does not?**

- several resources booked at once (a table and equipment),
- slots that depend on each other (cleaning between customers),
...
Not the number of bookings. These four things:

1. **Number of resources.** One stylist versus eight tables of differing capacity are different briefs.
2. **Rules.** Breaks, opening hours, holidays, minimum notice, blocking slots.
