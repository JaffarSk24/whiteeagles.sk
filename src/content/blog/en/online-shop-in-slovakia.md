---
title: 'Running an online shop in Slovakia: what to choose and what the law requires'
description: >-
  Launching an e-shop in Slovakia: ready platform or custom build, prices,
...
faq:
  ...
  - q: 'What documents must be on the shop''s website?'
    a: 'The company''s mandatory details, terms of business, a privacy policy, information about the 14-day right of withdrawal and about complaints, plus a cookie banner with Consent Mode v2.'
  - q: 'Ready platform or custom build?'
    a: 'A small catalogue with standard logic lives well on a ready platform. A custom build earns its keep when there is logic the platform lacks: volume pricing, warehouse integration, non-standard delivery.'
---
![Running an online shop in Slovakia | White Eagles & Co.](/assets/blog/internetmag.webp)

# Running an online shop in Slovakia: what to choose and what the law requires

Conversations about an e-shop usually start with the platform and end six months later with "why are there no sales". The right order is the reverse: first what you sell and to whom, then the law and the money, and only then the technology.

Below, in that order.

[CTA_FORM:consult]

## First, an honest question: do you need a shop at all

Not everyone needs a catalogue with a cart. If you have ten items, the sale happens after a conversation and the price depends on volume, what you need is a **catalogue with an enquiry form**. It is cheaper, faster and closer to how the deal actually works.

A shop with a cart earns its place when the purchase happens without you: the person chose, paid, received.

## Ready platform or custom build

An argument with no universal answer, so let us be concrete.
...
Real development prices are in [how much a website costs in Slovakia](/en/blog/website-cost-slovakia/).

## Accepting payment

The key choice, affecting both conversion and cost.
...
**Important from 1 May 2026:** a seller must make cashless payment possible on any purchase above one euro. For an e-shop that is largely the norm already, but it also applies to collection in person and to couriers.

## eKasa: when it applies and when it does not

A frequent source of panic, so point by point.
...
Three things that affect sales more than they appear to:
...
5. Build the shop.
6. Set up measurement before launch, not after.
7. Launch and watch where buyers are lost.
