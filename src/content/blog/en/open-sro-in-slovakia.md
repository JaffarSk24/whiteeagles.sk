---
title: 'How to open an s.r.o. in Slovakia in 2026: step by step and what changes on 17 August'
description: >-
  A full walk-through of registering an s.r.o. in Slovakia: share capital, court
...
faq:
  - q: 'Do I need to be a Slovak resident to open an s.r.o.?'
    a: 'No. A founder can be a citizen of another country. Separate requirements may apply to the managing director, which is worth checking against your specific situation.'
...
| Notary/lawyer fees | none | roughly **150-200€** on top |
...
The name is checked for uniqueness in the register at [orsr.sk](https://www.orsr.sk). Check it early: a rejection over a duplicate is the most annoying way to lose a week.
...
One thing for later: the address in that document has to match what you put on your website, in your Google listing and in your company details. Discrepancies stop Google from tying your company together as one entity. That affects whether you are found in searches for your own city.
...
1. **Get a DIČ**: the tax number. Registering with the tax office is mandatory.
2. **Open a corporate bank account.** Some services discount the registration if you open an account with a particular bank: Firmaren, for example, charges a 1 euro administrative fee when you open an account with Tatra banka. Compare total cost, not one line of it.
...
**A registered address that nobody checked.** The owner's consent has to be certified, so an ordinary signature is refused.
