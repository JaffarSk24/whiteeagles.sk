---
title: 'A website for a restaurant, café or bar: table booking, menu, footfall'
description: >-
  What a restaurant website has to do to bring guests rather than just show
  pretty photos: table booking without phone calls, a menu Google can read,
...
faq:
  - q: 'What does a restaurant website cost?'
    a: 'A simple site with menu, contact and booking from 3,500 euros; a landing page with one offer from 1,500. Included: the booking form, the Google profile, booking measurement, the cookie banner and 6 months of support. Changes at 35 euros an hour.'
...
A restaurant website usually comes into being like this: nice photos of dishes, an address, a menu as a PDF and a phone number. A year later the owner discovers that guests write on Facebook "anything free at seven?", the PDF menu is six months out of date, and Google read nothing in it.

Below: what a restaurant website **has** to do to bring guests, what can be left out, what it costs, and when a site is not needed at all.

[CTA_FORM:webdev]

## What a guest is actually looking for
...
Honestly, because ready services have their place.
...
## Footfall: where guests come from
...
- **A blog.** A restaurant does not write articles; it writes a menu.
...
I build sites for food and drink businesses with booking that confirms through Telegram and closes taken tables by itself, so staff never have to go anywhere. I do not register companies, keep books or handle hygiene permits; my part is the website, the booking, the Google profile and the measurement.
