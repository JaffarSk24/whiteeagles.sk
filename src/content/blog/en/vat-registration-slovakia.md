...
faq:
  - q: 'At what turnover does VAT registration become mandatory in Slovakia?'
    a: 'There are two thresholds. Exceeding 50,000 euros in a calendar year makes you a VAT payer from 1 January of the following year. Exceeding 62,500 euros makes you a payer immediately, with the very supply that crossed it.'
  - q: 'How is the turnover counted?'
    a: 'By calendar year, January to December. The old rolling twelve-month calculation no longer applies, so you only need to watch the current year.'
  - q: 'How long do I have to file?'
    a: 'Five working days from crossing the threshold. The tax office then has up to ten days to issue the decision and assign the IČ DPH.'
...
Related: [opening an s.r.o.](/en/blog/open-sro-in-slovakia/), [eKasa in 2026](/en/blog/ekasa-online-cash-register/) and [accepting card payments](/en/blog/accept-card-payments/).
