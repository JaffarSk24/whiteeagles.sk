...
faq:
  - q: 'GDPR касается совсем маленьких фирм?'
    a: 'Да. Порога по размеру компании нет: правила применяются к любому, кто обрабатывает персональные данные. Освобождение от ведения записей об обработке для организаций менее 250 человек существует, но оно не действует, если обработка регулярная, а форма заявки на сайте и есть регулярная обработка.'
  - q: 'Нужен ли мне отдельный специалист по защите данных?'
    a: 'Обычной небольшой компании такой специалист не нужен. Он обязателен для государственных органов и там, где обработка данных является основной деятельностью либо ведётся в большом масштабе с особыми категориями данных.'
  - q: 'Что должно быть на сайте как минимум?'
    a: 'Политика конфиденциальности с указанием, кто обрабатывает данные и на каком основании, срок хранения и права посетителя. В формах нужна отметка о согласии, не проставленная заранее, и ссылка на политику. Плюс cookie-баннер, если стоит аналитика или реклама.'
  ...
  - q: 'Что делать при утечке данных?'
    a: 'Уведомить надзорный орган в течение 72 часов с момента, когда стало известно, если утечка создаёт риск для людей. При высоком риске нужно уведомить и самих пострадавших.'
---
...
**Cookie-баннер**, если стоит аналитика или реклама. Это отдельная тема, подробно смотрите в статье [«Cookie-баннер в 2026»](/ru/blog/cookie-lista-2026-povinnosti/).
...
**Рассылка по всем контактам подряд.** Существующим клиентам писать о похожем можно, новым можно только с согласия.
