...
faq:
  - q: 'Potrebujem cookie lištu, ak mám len Google Analytics?'
    a: 'Áno. Analytické cookies vyžadujú súhlas rovnako ako reklamné. Bez súhlasu sa dá zaobísť len s nevyhnutnými technickými cookies, teda tými, bez ktorých web nefunguje.'
