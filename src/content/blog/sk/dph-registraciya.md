...
faq:
  ...
  - q: 'Aká je lehota na podanie žiadosti?'
    a: 'Päť pracovných dní od prekročenia hranice. Daňový úrad vydá rozhodnutie a pridelí IČ DPH do desiatich dní.'
  - q: 'Aké sadzby DPH platia v roku 2026?'
    a: 'Základná 23 percent, znížené 19 a 5 percent pre tovary uvedené v prílohe zákona. Od 1. januára 2026 sa na výrobky so zvýšeným obsahom cukru a soli uplatňuje základná sadzba 23 percent.'
  - q: 'Ako sa počíta obrat pre hranicu?'
    a: 'Podľa kalendárneho roka, od januára do decembra. Predchádzajúci výpočet za kĺzavých dvanásť mesiacov sa už neuplatňuje.'
...
Práve toto sa najčastejšie mýli. Hranice sú **dve** a dôsledky majú odlišné.
...
- **5 pracovných dní** od prekročenia hranice na podanie žiadosti
- **do 10 dní** má daňový úrad na vydanie rozhodnutia a pridelenie IČ DPH

Päť pracovných dní je krátko. Práve preto sa obrat sleduje priebežne, nie na konci roka, keď účtovník pozbiera doklady.
...
Registrovať sa dá aj bez čakania na hranicu. Zmysel to má v dvoch prípadoch.

**Vaši klienti sú sami platiteľmi DPH.** Pre nich vaša DPH nie je náklad, odpočítajú si ju. A vy získate právo odpočítať DPH zo svojich nákupov. Čistý zisk.
...
**E-shop treba prepočítať.** Sadzby 23, 19 a 5 percent podľa kategórií tovaru sú nastavenie v systéme, nie ručná úprava cien. Ak predávate potraviny aj nepotravinový tovar, kategórie treba rozdeliť.

**Faktúry menia podobu.** Pribúda povinný súbor údajov, ktorý sa pred registráciou nevyžadoval.

Ani jedna z týchto zmien nie je zložitá. Všetky sa predražia, ak sa robia po tom, ako už prvé faktúry odišli klientom.
...
Prvé tri body patria účtovníkovi. Štvrtý je môj.
