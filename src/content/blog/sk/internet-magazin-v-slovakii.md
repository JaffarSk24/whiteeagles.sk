...
## Najprv poctivá otázka: naozaj treba e-shop

Katalóg s košíkom nepotrebuje každý. Ak máte desať položiek, predaj prebieha po rozhovore a cena závisí od objemu, potrebujete skôr **katalóg s dopytovým formulárom**. Je lacnejší, rýchlejší a lepšie zodpovedá tomu, ako obchod reálne prebieha.
...
Kľúčová voľba, ktorá ovplyvňuje konverziu aj náklady.
...
**Dôležité od 1. mája 2026:** predávajúci je povinný umožniť bezhotovostnú platbu pri nákupe nad 1 euro. Pre e-shop je to v podstate už norma, ale pri osobnom odbere alebo kuriérovi sa to týka aj vás.

## eKasa: kedy treba a kedy nie

Častý zdroj paniky, preto po bodoch.
...
Tri veci, ktoré vplývajú na predaje viac, než sa zdá:
...
E-shop bez nastavenej analytiky elektronického obchodu sú mesačné náklady naslepo.
...
5. Postaviť e-shop.
6. Nastaviť meranie pred spustením, nie po ňom.
7. Spustiť a sledovať, kde sa strácajú kupujúci.
