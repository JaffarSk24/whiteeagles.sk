...
faq:
  - q: 'Čo treba urobiť hneď po založení firmy, ešte pred webom?'
    a: 'Kúpiť doménu na firmu (nie na dodávateľa), zriadiť e-mail na vlastnej doméne a založiť profil firmy na Googli. Všetko tri veci sú zadarmo alebo za pár eur a dajú sa stihnúť za jeden večer. Web sa dá riešiť až potom.'
...
## Štvrtý týždeň: meranie, bez ktorého sa nedá nič rozhodnúť

Web bez merania dopytov je výdavok, o ktorom nikdy nezistíte, či sa vrátil.

Minimum od prvého dňa: Google Analytics 4 cez Tag Manager, udalosť pri **úspešnom** odoslaní formulára (nie pri kliknutí na tlačidlo), označená ako kľúčová, prepojenie so Search Console. Znie to technicky, ale je to jediný spôsob, ako o mesiac vedieť, odkiaľ prišli dopyty a koľko stáli. Postup: [nastavenie GA4](/sk/blog/nastavenie-google-analytics-4/).

Sem patrí aj Search Console: zadarmo, ukazuje, na aké dopyty sa web zobrazuje. Pre novú firmu je to jediný zdroj pravdy o tom, čo ľudia hľadajú.

## Čo môže počkať

Poviem na rovinu, lebo to šetrí peniaze prvého mesiaca:

- **Platená reklama.** Kým web nemá meranie a stránku pre konkrétnu službu, reklama je platený odchod návštevníkov. Najprv body vyššie, potom [kolko stojí reklama](/sk/blog/kolko-stoji-reklama-na-slovensku/).
- **Sociálne siete ako hlavný kanál.** Pre B2B služby prinášajú málo; pre salón alebo reštauráciu áno, ale až po profile na Googli.
- **Logo za tisíce eur.** Zákazník kupuje riešenie problému, nie logo.
- **Chatbot, CRM, automatizácie.** Keď je päť dopytov týždenne, niet čo automatizovať.

## Čo nemôže počkať vôbec
...
1. Doména `.sk` zapísaná na firmu, autopredĺženie zapnuté.
2. E-mail na doméne + SPF, DKIM, DMARC.
3. Profil firmy na Googli, rovnaký NAP ako všade.
