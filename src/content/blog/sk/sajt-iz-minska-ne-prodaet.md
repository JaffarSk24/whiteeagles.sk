...
faq:
  ...
  - q: 'Nestačí web preložiť do slovenčiny?'
    a: 'Preklad vyrieši jazyk, nie zvyšok: povinné údaje, zaužívané spôsoby platby, miestne portály, očakávania od firmy. Preložená šablóna sa číta ako preložená šablóna.'
  - q: 'Čo konkrétne pri práci na diaľku chýba?'
    a: 'Možnosť stretnúť sa, slovenská faktúra s IČO do nákladov, znalosť miestnych požiadaviek na web a pochopenie toho, čo sa tu považuje za znak spoľahlivej firmy.'
  - q: 'A čo ak je web určený pre cudzojazyčných klientov?'
    a: 'Aj vtedy žije web v slovenskom prostredí: miestne pravidlá, miestne platobné zvyky, miestne vyhľadávanie. Jazyk rozhrania a trh sú dve rôzne veci.'
...
Podrobný zoznam je v článku [„Povinné údaje na webe“](/sk/blog/obyazatelnye-rekvizity-sajta/).

## 2. Platby nesprávnymi spôsobmi

Na weboch robených na diaľku býva sada platobných metód zaužívaná na inom trhu. Slovenský kupujúci pritom čaká platbu kartou, Apple Pay a Google Pay, platbu cez svoju bankovú aplikáciu a QR kód na prevod.

Osobitne: **od 1. mája 2026 musí predávajúci umožniť bezhotovostnú platbu** pri nákupe nad jedno euro. O tejto požiadavke zahraničné štúdio nevie jednoducho preto, že doma ju nemá. Podrobnosti sú v článku [„Prijímanie platby kartou na webe“](/sk/blog/priem-oplaty-kartoy/).

## 3. Cookie lišta, ktorá nespĺňa pravidlá

Európske požiadavky na súhlas sú prísnejšie než vo väčšine krajín mimo Únie: odmietnuť musí byť rovnako ľahké ako súhlasiť, kategórie oddelené, pred súhlasom sa nenačíta nič.

Typická lišta s jediným tlačidlom „Prijať“ požiadavkám nevyhovuje. K tomu bez Consent Mode v2 prestáva fungovať reklama. [Rozbor je tu](/sk/blog/cookie-lista-2026-povinnosti/).

## 4. Nezohľadnené miestne vyhľadávanie
...
Pre časť klientov je to rozhodujúce. Možnosť stretnúť sa v Bratislave, pozrieť si jeden druhého a prebrať projekt pri stole je to, čo vzdialený dodávateľ nikdy nedá.

Sem patrí aj rozdiel časových pásiem pri havárii. Keď web spadne v stredu o desiatej ráno, záleží na tom, či človek, ktorý ho opravuje, pracuje v rovnakých hodinách ako vy.

## 7. Faktúra, ktorú sa nedá zaúčtovať

Praktický bod, ktorý sa zvyčajne objaví na konci. Slovenská firma s IČO vystaví faktúru, ktorú si dáte do nákladov a odpočítate DPH. Faktúra od zahraničného dodávateľa je pre účtovníctvo iný príbeh: prenesenie daňovej povinnosti, ďalšie výkazy, a niekedy to účtovník jednoducho odmietne.

Rozdiel v hodinovej sadzbe, kvôli ktorému sa to celé začalo, sa tu často aj minie.

## Čo z toho vyplýva

Nie to, že sa na diaľku pracovať nedá. Veľa úloh sa výborne rieši na diaľku a sám pracujem s klientmi z iných miest online.
...
1. Je v pätičke IČO, DIČ a údaj o zápise v registri?
2. Dá sa zaplatiť kartou a cez bankovú aplikáciu?
...
Na Slovensku žijem viac ako desať rokov a spustil som **12+ webov pre slovenské firmy**: Biliardovňa, Krása štúdio, Top Sklad, Synchro Žralok, Bodabo a ďalšie. Viem nielen, ako sa to programuje, ale aj ako sa tu správa kupujúci a čo vyžaduje miestna regulácia.

Pracujem ako slovenské s.r.o., vystavujem faktúru s IČO a v Bratislave sa stretneme osobne. Dohodnúť sa môžeme po slovensky aj po rusky.

Súvisiace: [ako si Slováci vyberajú dodávateľa](/sk/blog/kak-slovaki-vybirayut-podryadchika/), [treba web po slovensky](/sk/blog/nuzhen-li-sajt-na-slovackom/) a [stránka služby „Tvorba webstránok“](/sk/service/webdev/).
