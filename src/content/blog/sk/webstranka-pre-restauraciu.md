---
title: 'Webstránka pre reštauráciu, kaviareň či bar: rezervácia stolov, menu, návštevnosť'
description: >-
  Čo musí mať web reštaurácie, aby priniesol hostí, nie iba pekné fotky:
...
faq:
  - q: 'Koľko stojí web pre reštauráciu?'
    a: 'Jednoduchý web s menu, kontaktom a rezerváciou od 3 500 eur; landing page s jednou ponukou od 1 500. V cene je rezervačný formulár, profil na Googli, meranie rezervácií, cookie lišta a 6 mesiacov podpory. Hodinová sadzba na úpravy 35 eur.'
...
Web reštaurácie zvyčajne vzniká takto: pekné fotky jedál, adresa, menu v PDF a telefón. O rok majiteľ zisťuje, že hostia píšu na Facebook „máte voľné o siedmej?", menu v PDF je pol roka staré a Google v ňom nič neprečítal.

Nižšie to, čo web reštaurácie **musí** vedieť, aby priviedol hostí, čo sa dá vynechať, koľko to stojí a kedy web netreba vôbec.

[CTA_FORM:webdev]

## Čo hosť vlastne hľadá
...
Poctivo, lebo hotové služby majú svoje miesto.
...
## Návštevnosť: odkiaľ hostia prídu
...
- **Blog.** Reštaurácia nepíše články; píše menu.
