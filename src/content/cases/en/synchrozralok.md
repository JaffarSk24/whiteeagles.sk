---
title: 'Synchro Žralok: a bilingual club website that updates itself'
description: >-
...
summary: 'A swimming club: two languages and a feed that updates itself.'
service: 'webdev'
services:
  - 'Web development'
  - 'Two languages'
...
A synchronised swimming club in Bratislava. A site in two languages where the news feed is pulled automatically from the club's public Instagram.
...
Meanwhile the club's Instagram is alive: photos from training, results, announcements. They are simply two separate worlds, and nobody carries one into the other.
...
Slovak and English versions, each on its own URL and linked by hreflang. For a club in the capital this is practical: Bratislava has many international families, and an English site is the only way for them to work out where to sign their child up.

A visitor whose system is Slovak lands on the Slovak version, everyone else on English. The switch stays: the choice is always the visitor's.
...
Responsive layout, fast loading, automatic content retrieval from a public profile, two language versions with correct markup, mandatory legal details and a cookie banner. Domain and hosting registered to the client.
